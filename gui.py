...
run_image = Image.open('/Users/jamesbaxter/PycharmProjects/finances/sync_pic.png')  # change at production
run_image = run_image.resize((300, 100), Image.ANTIALIAS)
run_image = ImageTk.PhotoImage(run_image)


# runs merge_inventory.py
def run_button_click():
    messagebox.showinfo('System_Status:', 'Inventory has been synchronized')
    inventory_live.makes_ledger_live()
